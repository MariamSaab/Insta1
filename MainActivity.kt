...
import com.elenakozachenko.instaphoto.R.id.photosView
    ...
    fun loadPhotos(){
        api.getPhotos().enqueue(object: Callback<List<Photo>>{
            override fun onResponse(call: Call<List<Photo>>,
                ...
                photosView.adapter = PhotosAdapter(listOf())
            }
...
val stream = ByteArrayOutputStream()
        ...
        val photoReq = RequestBody.create(MediaType.parse("image/jpeg"),
                stream.toByteArray())
        val body = MultipartBody.Part.createFormData(
                "image", "asd.jpeg", photoReq).body()
